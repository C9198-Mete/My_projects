...
def calc():
    if request.method == "POST":
        my_number1 = request.form.get("number1")
        my_number2 = request.form.get("number2")
        return render_template("result.html", var1 = my_number1, var2 = my_number2, result = lcm(int(my_number1),int(my_number2)), developer_name="Mete")
    else:
        return render_template("result.html", developer_name="Mete")    
